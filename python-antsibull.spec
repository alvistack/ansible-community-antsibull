...
Requires: python3-antsibull-changelog >= 0.10.0
...
%license LICENSE
%{_bindir}/antsibull-build
%{_bindir}/antsibull-docs
%{_bindir}/antsibull-lint
%{python3_sitelib}/antsibull*
%{python3_sitelib}/sphinx_antsibull_ext*
%endif
